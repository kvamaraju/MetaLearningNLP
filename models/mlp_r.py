...
class MLPR(nn.Module):
    def __init__(self,
        ...
        self.domain_classifier = nn.Linear(in_features=hidden_dim, out_features=2)
    ...
    def forward(self,
        ...
        return self.classifier(output), self.domain_classifier(GradientReversalFunction.apply(output, alpha))
